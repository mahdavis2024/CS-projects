...
def opening(folderpath = Path.cwd()):
    ...
    try:
        ...
        print('files in folder', folder_path.resolve())
...
def show(files_in_folder):
    ...
    Because the xlsx in a binary format, it is not easily readable with just built_in Python functions.
    ...
    try:
        ...
        print(f'****File content dispalyed successfully!\n')
...
def showxl(address = Path.cwd()):
    ...
    try:
        ...
        print('****Sheet content dispalyed successfully!\n')                    
